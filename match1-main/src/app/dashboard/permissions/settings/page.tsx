...
export default function PermissionSettingsPage() {
  ...
  const fetchPolicies = async () => {
    try {
      const response = await fetch('/api/permissions/policies', { credentials: 'include' });
      if (response.ok) {
  ...
  const fetchSecurityConfig = async () => {
    try {
      const response = await fetch('/api/permissions/security-config', { credentials: 'include' });
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchAuditConfig = async () => {
    try {
      const response = await fetch('/api/permissions/audit-config', { credentials: 'include' });
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchSystemStatus = async () => {
    try {
      const response = await fetch('/api/permissions/system-status', { credentials: 'include' });
      if (response.ok) {
        const data = await response.json();
